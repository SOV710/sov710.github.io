...
<ul>
<li>大一上在玩算法，玩图形学，结果是图形学矩阵都没学明白就微距了，算法学到红黑树后热情消退，遂放弃，算是试错成本吧</li>
...
<p>但是接下来是噩梦时光：</p>
<ul>
<li>开学第二周～第五周，在leader介绍下接了一个单子（做过的最踏马蠢的选择之一），做一个基于 MySQL + Django + Vue 的web毕设，也有自己给自己上强度了导致做的很痛苦的原因（天天熬夜 + 被用户认证逻辑折磨），但是主要后悔的是，做这b web和我目前的方向完全不搭，我根本不喜欢这个方向啊呜；只能说是被1k块钱冲昏头了</li>
<li>吃了拖大的，不过终于阶段性结束了，开始学忍了好久的东西</li>
</ul>
<h3 id="这周做了什么" tabindex="-1"><a class="header-anchor" href="#这周做了什么"><span>这周做了什么</span></a></h3>
<ul>
<li>因为TTY里折腾不明白clash所以开始学计网，计网主看cs144，看了20%后三分钟热度消退，目前缓慢推进ing</li>
<li>因为想玩明白gentoo所以开始学os，主要学习路线是ChatGPT + cs163结合，辅以 hit os + linux 源码</li>
<li>在 @东川路第一伊蕾娜 的群里认识了很多一起做 sys / arch 的朋友，那很有动力了</li>
...
<ul>
<li>速通cs163 lecture，建构起os的整个框架：
<ul>
<li>从CPU视角理清进程的生命周期</li>
<li>理清对于cache/vp/硬盘寻址的整个流程</li>
<li>学习bootloader并且做到能修bootloader（之前双系统时grub2频频被Windows创坏，恼）</li>
<li>理解驱动的原理，可能的话再加上文件系统</li>
</ul>
</li>
<li>速通cs144 lecture，建构起整个计算机网络的框架：
<ul>
<li>梳理各种packet在互联网中的生命历程</li>
<li>有时间的话学习clash的原理 + 看clash-rs源码（optional）</li>
</ul>
</li>
<li>学rust，至少得把基础语法弄懂</li>
<li>那个毕设项目还得继续跟，但是实在不知道为什么用户认证逻辑做不出来；至今没搞清楚cookies到底是在前端没发出去，还是在浏览器被拦截了，还是后端接口做错了没检测到cookies被惨遭403，之前调了两天实在调不动了，梳理一下项目脉络，等实验室一个做前端的哥们回来后问问他</li>
<li>理解Linux的模组加载原理，学习Intel VTX，看Xen + KVM + RVM + rCore的源码，准备写个hypervisor</li>
</ul>
<p>小声逼逼：Intel的股价跌得好快，现在开始研究 intel VTX 而不是 AMD-V 颇有种49年入国军的感觉……</p>
<h3 id="吐槽" tabindex="-1"><a class="header-anchor" href="#吐槽"><span>吐槽</span></a></h3>
<p>iPad做文字处理工作确实不大行……诡异的蓝色框框不知道在锁什么</p>
</div></template>
